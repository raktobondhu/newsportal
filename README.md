...
```
RSS (৫ সোর্স) → ডিডুপ ও র‍্যাঙ্কিং → আর্টিকেল এক্সট্র্যাক্ট
...
`.github/workflows/pipeline.yml` — প্রতি ২ ঘণ্টায় একবার।
দিনে ~৬০টি আর্টিকেল, ~২৪টি ফেসবুক পোস্ট (ফ্রি কোটার হিসাব ধরে)।
